...
| --- | --- | --- |
| **PRJ-001 — Compliance as Code** | OPA/Rego policy enforcement mapped to PCI DSS v4.0, SOC 2, and NIST 800-53. Gated CI pipeline. 50/50 passing policy tests. | ✅ Shipped |
