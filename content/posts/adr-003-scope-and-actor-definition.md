---
title: "ADR-003: Scope and Actor Definition"
date: 2026-07-08
draft: false
tags: ["adr", "security-architecture", "gcp", "iam", "pam"]
categories: ["architecture-decisions"]
description: "Architecture decision on scoping BankVault to one actor and one resource: why a single underwriter/credit-report pair beats a general-purpose JIT platform."
---

A mortgage lender's underwriter has to read a borrower's credit report to approve or deny a loan. That report is some of the most sensitive data a lender holds, and federal law (the GLBA Safeguards Rule) says access to it must be limited to the people who need it, for only as long as they need it. This decision picks the exact person-and-file pair BankVault is built to protect, and explains why the project starts there instead of trying to cover every sensitive system at once.

> **TL;DR**
>
> - **Decision:** Build the whole broker around one pair, an underwriter reading one credit report, instead of a general-purpose JIT platform.
> - **Status:** Accepted
> - **Owner:** Lanre Oluokun
> - **Date:** 2026-07-08
...
- **314.4(c)(1)(i) to (ii):** requires authenticating and permitting access only to authorized users, and limiting authorized users' access to only the customer information they need to perform their duties. That's the basis for the JIT, need-based access model carried into ADR-004 and ADR-005.
